...
func (c *dhcpConn) broadcast(respData []byte, peer *net.UDPAddr) (n int, err error) {
	...
	// https://github.com/AdGuardPrivate/AdGuardPrivate/issues/3289.  The DHCP
	...
	//
	// See https://github.com/AdGuardPrivate/AdGuardPrivate/issues/3480 and
	// https://github.com/AdGuardPrivate/AdGuardPrivate/issues/3366.
	//
	// See also https://github.com/AdGuardPrivate/AdGuardPrivate/issues/3539.
